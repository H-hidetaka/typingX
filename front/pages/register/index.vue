...
<script lang="ts">
import Vue from 'vue'
// import {ValidationProvider, ValidationObserver} from '../plugins/vee-validate.js'
...
export default Vue.extend({
  ...
  methods: {
    register() {
      this.$axios.post('users', { user: { user: this.user }})
      .then(res => {
  ...
  //         '半角英小文字大文字数字をそれぞれ1種類以上含む7文字以上128文字以下で入力してくださいveevalidate'
  //     }
  //   }
  // },
});
